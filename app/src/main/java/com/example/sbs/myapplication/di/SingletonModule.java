...
public class SingletonModule {
    ...
    @Provides
    @Singleton
    public static PokemonService providePokemonService(PokeApi pokeApi) {
        return new PokemonService(pokeApi);
    }

    @Provides
    @Singleton
    public static PokeApi providePokeApi(Retrofit.Builder retrofitBuilder) {
